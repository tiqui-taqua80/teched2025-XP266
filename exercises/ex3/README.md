...
4. In Create project popup, choose S**AP Fiori Application** and confirm with **Next**.
...
5. At this point you need to allow Business Application Studio to push changes to your repository. Follow the steps as displayed.
6. Back Business Application Studio save your credentials for this session only.
7. Your code changes been now added to Git Repository.
